                ...
                <div class="col-md-4">
                    <div class="login-container">
                        ...
                        <form class="auth-login-form mt-2" method="POST" action="">
                            ...
                            <input type="text" class="form-control" name="email" id="login-email" placeholder="Email"
                                aria-describedby="login-email" tabindex="1" />

                            <input type="password" class="form-control form-control-merge" id="login-password"
                                name="password" tabindex="2" placeholder="Password" aria-describedby="login-password" />

                            <button type="submit" class="login-btn" tabindex="4">Register</button>
                            <br>
                            <br>
                            Already have an account?<a class="forgot-password" href=""> Login In</a>
                        </form>
