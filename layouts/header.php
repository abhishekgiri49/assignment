    ...
    <div class="navbar">
                ...
                <li><a href="">Men</a>
                    <div class="categoryContainer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <h6 class="menu-title">footwear</h6>
                                <ul>
                ...
                <li><a href="">women</a>
                    ...
                    <div class="list-bg">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <h6 class="menu-title">lingarie</h6>
                                <ul>
                                    <li><a href="">bra</a></li>
        ...
        <div class="nav-profile">
            <ul>
                ...
                <li><span><img src="images/cart.png"><a href="">Cart</a><span></li>
            </ul>
        </div>
